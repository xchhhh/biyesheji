...
Page({
  ...
  // 模态框控制
  onOpenSeatSelection() {
    console.log("onOpenSeatSelection clicked!"); this.setData({ showSeatSelectionModal: true });
  },
  onCloseSeatSelection() {
    this.setData({ showSeatSelectionModal: false });
  },
  onOpenHeatmapModal() {
    console.log("onOpenHeatmapModal clicked!"); this.setData({ showHeatmapModal: true });
  },
  onCloseHeatmapModal() {
    this.setData({ showHeatmapModal: false });
  },
